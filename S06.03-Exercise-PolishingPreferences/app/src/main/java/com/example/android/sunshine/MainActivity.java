...
public class MainActivity extends AppCompatActivity implements
    ...
    private static boolean mPreferencesChanged = false;
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle loaderArgs) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                boolean isUnitMetric = SunshinePreferences.isMetric(MainActivity.this);
                String unit = isUnitMetric ? getString(R.string.pref_units_metric).toLowerCase() : getString(R.string.pref_units_imperial).toLowerCase();
                URL weatherRequestUrl = NetworkUtils.buildUrl(locationQuery, unit);
